...
if __name__ == '__main__':
    ...
    # PATHS FOR MULTIOME
    TRAIN_H5AD = 'data/raw/lymph_node_lymphoma_14k_raw_feature_bc_matrix.h5' 
    DATA_ROOT = 'data/processed/multiome'
    ...
    if test_adata is not None:
         ...
         if generated_datasets_counts and VIZ:
              ...
              if train_dataset and hasattr(train_dataset, 'cell_type_categories'):
